...
class PBMIT_BlogElement extends Widget_Base{
	...
	public function get_title() {
		...
		$blog_cpt_singular_title	= esc_attr__('Blog','xcare');
		...
		return sprintf( esc_attr__( 'Xcare %1$s Element', 'xcare') , $blog_cpt_singular_title );
	}
	...
	protected function register_controls() {
		...
		$blog_cpt_title	= esc_attr__('Blog','xcare');
		...
		$blog_cat_singular_title	= esc_attr__('blog Category','xcare');
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => sprintf(esc_attr__( '%1$s Style Options', 'xcare' ), $blog_cpt_singular_title ),
		...
		$this->add_control(
			'style',
			[
				'label'			=> sprintf( esc_attr__( 'Select %1$s View Style', 'xcare' ), $blog_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'Select  %1$s View style.', 'xcare' ), $blog_cpt_singular_title ),
		...
		$this->add_control(
			'view-type',
			[
				'label'			=> sprintf( esc_attr__( 'How you like to view each %1$s box?', 'xcare' ), $blog_cpt_singular_title ),
		...
		$this->add_control(
			...
			[
				...
				'description' 	=> sprintf( esc_attr__( 'Select YES to dynamically load more %1$s', 'xcare' ), $blog_cpt_title ),
		...
		$this->add_control(
			...
			[
				...
				'default'		=> esc_attr__( 'Our Blog', 'xcare' ),
		...
		$this->start_controls_section(
			'data_section',
			[
				'label'	=> sprintf( esc_attr__( '%1$s Content Options', 'xcare' ), $blog_cpt_singular_title ),
			]
		);
		$this->add_control(
			'from_category',
			[
				'label' 		=> sprintf( esc_attr__( 'Show %2$s from selected %1$s?', 'xcare' ), $blog_cat_singular_title, $blog_cpt_singular_title ),
		...
		$this->add_control(
			'show',
			[
				'label' 	  => sprintf( esc_attr__( '%1$s to show', 'xcare' ), $blog_cpt_singular_title ),
				'description' => sprintf( esc_attr__( 'How many %1$s you want to show.', 'xcare' ), $blog_cpt_singular_title ),
				'separator'   => 'before',
		...
		$this->add_control(
			'sortable',
			[
				'label'			=> sprintf( esc_attr__( 'Show Sortable %1$s?', 'xcare' ), $blog_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'Select YES to show sortable %1$s.', 'xcare' ), $blog_cpt_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xcare' ),
				'label_off'		=> esc_attr__( 'No', 'xcare' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=> sprintf( esc_attr__( 'Select YES to load %1$s using Ajax on click on the category.', 'xcare' ), $blog_cpt_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xcare' ),
				'label_off'		=> esc_attr__( 'No', 'xcare' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			'pagination',
			[
				'label' 		=> esc_attr__( 'Show Pagination ?', 'xcare' ),
				'description' 	=>  sprintf( esc_attr__( 'Select YES to Show pagination links below %1$s boxes.', 'xcare' ), $blog_cpt_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xcare' ),
				'label_off'		=> esc_attr__( 'No', 'xcare' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			'ajax_pagination',
			[
				'label'			=> esc_attr__( 'Load post without page refresh on Pagination click ?', 'xcare' ),
				'description' 	=>  sprintf( esc_attr__( 'Select YES to load Posts without page refresh (ajax based) when click on the pagination links.', 'xcare' ), $blog_cpt_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xcare' ),
				'label_off'		=> esc_attr__( 'No', 'xcare' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description' => sprintf( esc_attr__( ' Sort retrieved %1$s by parameter.', 'xcare' ), $blog_cpt_singular_title ),
				'type' 		  => Controls_Manager::SELECT,
				'default' 	  => 'none',
				'options' 	  => [
		...
		$this->add_control(
			'offset',
			[
				'label'			=> sprintf( esc_attr__( 'Skip %1$s (offset)', 'xcare' ), $blog_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'How many  %1$s you like to skip.', 'xcare' ), $blog_cpt_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'label_block'	=> true,
				'default'		=> '',
				'options'		=> [
					''			=> sprintf(esc_attr__( 'Show All %1$s (No skip)', 'xcare' ), $blog_cpt_title ),
					'1'			=> sprintf(esc_attr__( 'Skip first %1$s', 'xcare' ), $blog_cpt_singular_title ),
					'2'			=> sprintf(esc_attr__( 'Skip two %1$s', 'xcare' ), $blog_cpt_title ),
					'3'			=> sprintf(esc_attr__( 'Skip three %1$s', 'xcare' ), $blog_cpt_title ),
					'4'			=> sprintf(esc_attr__( 'Skip four %1$s', 'xcare' ), $blog_cpt_title ),
					'5'			=> sprintf(esc_attr__( 'Skip five %1$s', 'xcare' ), $blog_cpt_title ),
				],
				'condition'	=> [
					'ajax_sortable!' => 'yes',
				]
		...
		$this->add_control(
			'gap_options',
			[
				'label'			=> sprintf( esc_attr__( 'Gap between %1$s boxes', 'xcare' ), $blog_cpt_singular_title ),
				'type'			=> Controls_Manager::HEADING,
				'separator'		=> 'before',
				'condition' => [
					'style!'	=> ['1'],
		...
		$this->add_control(
			...
			[
				...
				'description' =>  sprintf( esc_attr__( 'Gap between each %1$s box.', 'xcare' ), $blog_cpt_singular_title ),
				'type' 		  => Controls_Manager::SELECT,
				'default' 	  => 'default',
				'options' 	  => [
