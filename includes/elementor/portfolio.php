...
class PBMIT_PortfolioElement extends Widget_Base{
	...
	public function get_title() {
		...
		return sprintf( esc_attr__( 'Xcare %1$s Element', 'xcare' ), $portfolio_cpt_singular_title );
	}
	...
	protected function register_controls() {
		...
		// Portfolio
		$portfolio_cpt_title	= esc_attr__('Portfolio','xcare');
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => sprintf( esc_attr__( '%1$s Style Options', 'xcare' ), $portfolio_cpt_singular_title ),
		...
		$this->add_control(
			'style',
			[
				'label'			=> sprintf( esc_attr__( 'Select %1$s View Style', 'xcare' ), $portfolio_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'Select %1$s View Style', 'xcare' ), $portfolio_cpt_singular_title ),
		...
		$this->add_control(
			'view-type',
			[
				'label'			=> sprintf( esc_attr__( 'How you like to view each %1$s box?', 'xcare' ), $portfolio_cpt_singular_title ),
		...
		$this->add_control(
			...
			[
				...
				'description'	=> esc_attr__( 'Set to YES to enable continuous loop mode. Set NO to enable rewind loop mode.', 'xcare' ),
				'type'			=> Controls_Manager::SELECT,
				'default'		=> '1',
				'options'		=> [
					'1'				=> esc_attr__( 'Yes', 'xcare' ),
		...
		$this->add_control(
			...
			[
				...
				'description' 	=> sprintf(esc_attr__( 'Select YES to dynamically load more %1$s', 'xcare' ), $portfolio_cpt_title ),
		...
		$this->add_control(
			...
			[
				...
				'default' 	  => sprintf( esc_attr__( 'Our %1$s', 'xcare' ), $portfolio_cpt_singular_title ),
		...
		$this->start_controls_section(
			'data_section',
			[
				'label' => sprintf( esc_attr__( '%1$s Content Options', 'xcare' ), $portfolio_cpt_singular_title ),
			]
		);
		$this->add_control(
			'from_category',
			[
				'label' 		=> sprintf( esc_attr__( 'Show %2$s from selected %2$s?', 'xcare' ), $portfolio_cpt_singular_title, $portfolio_cat_singular_title ),
		...
		$this->add_control(
			'show',
			[
				'label' 	  => sprintf( esc_attr__( '%1$s to show', 'xcare' ), $portfolio_cpt_singular_title ),
				'description' => sprintf( esc_attr__( 'How many %1$s you want to show.', 'xcare' ), $portfolio_cpt_singular_title ),
				'separator'   => 'before',
		...
		$this->add_control(
			'sortable',
			[
				'label' 	  => sprintf( esc_attr__( 'Show Sortable %1$s?', 'xcare' ), $portfolio_cat_singular_title ),
				'description' => sprintf( esc_attr__( 'Select YES to show sortable %1$s.', 'xcare' ), $portfolio_cat_singular_title ),
				'type' 		  => Controls_Manager::SWITCHER,
				'label_on' 	  => esc_attr__( 'Yes', 'xcare' ),
				'label_off'   => esc_attr__( 'No', 'xcare' ),
				'return_value'=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description'	=> sprintf( esc_attr__( 'Select YES to load %1$s using Ajax on click on the category.', 'xcare' ), $portfolio_cat_singular_title ),
				'type'			=> Controls_Manager::SWITCHER,
				'label_on'		=> esc_attr__( 'Yes', 'xcare' ),
				'label_off'		=> esc_attr__( 'No', 'xcare' ),
				'return_value'	=> 'yes',
		...
		$this->add_control(
			...
			[
				...
				'description' => sprintf( esc_attr__( ' Sort retrieved %1$s by parameter.', 'xcare' ), $portfolio_cpt_singular_title ),
				'type' 		  => Controls_Manager::SELECT,
				'default' 	  => 'none',
				'options' 	  => [
		...
		$this->add_control(
			'offset',
			[
				'label'			=> sprintf( esc_attr__( 'Skip %1$s (offset)', 'xcare' ), $portfolio_cpt_singular_title ),
				'description'	=> sprintf( esc_attr__( 'How many %1$s you like to skip.', 'xcare' ), $portfolio_cpt_singular_title ),
				'type'			=> Controls_Manager::SELECT,
				'label_block'	=> true,
				'default'		=> '',
				'options'		=> [
					''			=> sprintf( esc_attr__( 'Show All %1$s (No skip)', 'xcare' ), $portfolio_cpt_singular_title ),
					'1'			=> sprintf( esc_attr__( 'Skip first %1$s', 'xcare' ), $portfolio_cpt_singular_title ),
					'2'			=> sprintf( esc_attr__( 'Skip two %1$s', 'xcare' ), $portfolio_cpt_title ),
					'3'			=> sprintf( esc_attr__( 'Skip three %1$s', 'xcare' ), $portfolio_cpt_title ),
					'4'			=> sprintf( esc_attr__( 'Skip four %1$s', 'xcare' ), $portfolio_cpt_title ),
					'5'			=> sprintf( esc_attr__( 'Skip five %1$s', 'xcare' ), $portfolio_cpt_title ),
				],
				'condition'	=> [
					'ajax_sortable!' => 'yes',
				]
		...
		$this->add_control(
			'gap_options',
			[
				'label'			=> sprintf( esc_attr__( 'Gap between %1$s boxes', 'xcare' ), $portfolio_cpt_singular_title ),
				'type'			=> Controls_Manager::HEADING,
				'separator'		=> 'before',
			]
		);
		$this->add_control(
			...
			[
				...
				'description' =>  sprintf( esc_attr__( 'Gap between each %1$s box.', 'xcare' ), $portfolio_cpt_singular_title ),
				'type' 		  => Controls_Manager::SELECT,
				'default' 	  => 'default',
				'options' 	  => [
	...
	protected function render() {
		...
		if( $style == '2' && $settings['view-type'] =='carousel'){
			$masonry_image_size_array = array(
				'pbmit-img-890x990', // For masonry 1st box
				'pbmit-img-890x810', // For masonry 2nd box
			);
		} 
