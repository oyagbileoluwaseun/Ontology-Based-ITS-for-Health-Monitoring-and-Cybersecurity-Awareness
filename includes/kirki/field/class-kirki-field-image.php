...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'	   => esc_html__( 'Select image', 'xcare' ),
				'change'	   => esc_html__( 'Change image', 'xcare' ),
				'default'	  => esc_html__( 'Default', 'xcare' ),
				'remove'	   => esc_html__( 'Remove', 'xcare' ),
				'placeholder'  => esc_html__( 'No image selected', 'xcare' ),
				'frame_title'  => esc_html__( 'Select image', 'xcare' ),
				'frame_button' => esc_html__( 'Choose image', 'xcare' ),
			)
		);
	}
