...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'	   => esc_html__( 'Ultra-Light 100', 'xcare' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'xcare' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'xcare' ),
			'200'	   => esc_html__( 'Light 200', 'xcare' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'xcare' ),
			'300'	   => esc_html__( 'Book 300', 'xcare' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'xcare' ),
			'400'	   => esc_html__( 'Normal 400', 'xcare' ),
			'regular'   => esc_html__( 'Normal 400', 'xcare' ),
			'italic'	=> esc_html__( 'Normal 400 Italic', 'xcare' ),
			'500'	   => esc_html__( 'Medium 500', 'xcare' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'xcare' ),
			'600'	   => esc_html__( 'Semi-Bold 600', 'xcare' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'xcare' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'xcare' ),
			'700'	   => esc_html__( 'Bold 700', 'xcare' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'xcare' ),
			'800'	   => esc_html__( 'Extra-Bold 800', 'xcare' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'xcare' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'xcare' ),
			'900'	   => esc_html__( 'Ultra-Bold 900', 'xcare' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'xcare' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'xcare' ),
		);
	}
