...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'xcare' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'xcare' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'xcare' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'xcare' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'xcare' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'xcare' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'xcare' ); ?>',
} );
#>
