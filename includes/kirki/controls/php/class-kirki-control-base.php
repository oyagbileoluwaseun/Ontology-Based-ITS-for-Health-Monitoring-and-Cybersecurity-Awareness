	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'	   => esc_html__( 'No File Selected', 'xcare' ),
				'remove'			   => esc_html__( 'Remove', 'xcare' ),
				'default'			  => esc_html__( 'Default', 'xcare' ),
				'selectFile'		   => esc_html__( 'Select File', 'xcare' ),
				'standardFonts'		=> esc_html__( 'Standard Fonts', 'xcare' ),
				'googleFonts'		  => esc_html__( 'Google Fonts', 'xcare' ),
				'defaultCSSValues'	 => esc_html__( 'CSS Defaults', 'xcare' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'xcare' ),
			)
		);
